...
// const eventTools: AllowedTools[] = ["searchEvents"];
    ...
    execute: (dataStream) => {
      ...
      const result = streamText({
        ...
        tools: {
          // searchEvents: {
          //   description:
          //     "Create a document to query filtered events based on the user’s desired conditions. This tool displays events matching the user’s specified conditions through the document.",
          // parameters: z.object({
          //   type: z
          //     .string()
          ...
          getWeather: {
            ...
            execute: async ({ latitude, longitude }) => {
              try {
                ...
                // );
                const response = await fetch(
                  `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=6a636df9b71e043885721a778d5eabbc`
                );
